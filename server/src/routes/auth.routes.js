...
router.put("/users/:id/role", authRequired, roleRequired([ROLES.ADMIN]), authController.updateUserRole);

// Ruta para que un administrador obtenga la lista de todos los técnicos.
// GET /api/users/tecnicos
router.get("/users/tecnicos", authRequired, roleRequired([ROLES.ADMIN]), authController.getTecnicos);

// Ruta para que un administrador obtenga la lista de todos los usuarios.
// GET /api/users
router.get("/users", authRequired, roleRequired([ROLES.ADMIN]), authController.getAllUsersController);
